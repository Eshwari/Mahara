...
function create_user($user, $profile=array(), $institution=null, $remoteauth=null, $remotename=null) {
	...
	//Start of test code for ASU ID
	if (isset($user->asu_id) && $user->asu_id != '') {
        set_profile_field($user->id, 'asu_id', $user->asu_id);
    }	
	
	if (isset($user->degree_id) && $user->degree_id != '') {
        set_profile_field($user->id, 'degree_id', $user->degree_id);
    }	
