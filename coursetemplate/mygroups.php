...
define('INTERNAL', 1);
define('MENUITEM', 'coursetemplate/mygroups');
...
$pagination = build_pagination(array(
    'url' => get_config('wwwroot') . 'coursetemplate/mygroups.php?filter=' . $filter,
    'count' => $results['count'],
    'limit' => $groupsperpage,
    'offset' => $offset,
...
$smarty->assign('searchingforgroups', array('<a href="' . get_config('wwwroot') . 'coursetemplate/find.php">', '</a>'));
$smarty->assign('PAGEHEADING', hsc(get_string('mygroups')));
$smarty->display('coursetemplate/mygroups.tpl');


function filter_submit(Pieform $form, $values) {
    redirect('/coursetemplate/mygroups.php?filter=' . $values['options']);
}
