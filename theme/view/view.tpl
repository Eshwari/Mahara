...
<div id="view" class="cb">
  ...
  <div class="viewfooter cb">
	...
	{if $selfevaluation}
		...
		<br/>
		<a href="{$WWWROOT}view/listassessments.php?id={$viewid}&courseoutcome={$submittedcourseoutcome}&first={$submittedcourseoutcome}">View Assessment</a>
		<br/>
		{if $admin && $display==1} 
			<a href="{$WWWROOT}view/showassessments.php?id={$viewid}&courseoutcome={$submittedcourseoutcome}&first={$submittedcourseoutcome}">View Assessment by committee</a>		
			<br/>
			{if $finalAssessment}
				<a href="{$WWWROOT}view/finalassessment.php?id={$viewid}&courseoutcome={$submittedcourseoutcome}">Provide Final Assessment</a>
				<br/>
			{/if}
		{/if}
		<br/>
